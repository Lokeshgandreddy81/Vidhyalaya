...
export function executeSanitizedUserCode(userCodeString) {
  ...
  // Use Object.create(null) to avoid prototype chain escapes
  ...
  // Do not inject host functions like exit() to prevent Function traversal
  executionContextSandbox.global = Object.create(null);
  executionContextSandbox.require = null;

  // Use createContext with strict codeGeneration to disable strings and wasm
