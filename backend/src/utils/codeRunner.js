...
export function executeSanitizedUserCode(userCodeString) {
  // Use Object.create(null) recursively to break prototype chains
  ...
  // We strictly avoid injecting any host functions like "exit" as they retain Function.prototype
