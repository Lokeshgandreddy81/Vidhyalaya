...
export function executeSanitizedUserCode(userCodeString) {
  ...
  // recursively using Object.create(null) to prevent prototype chain escapes
  ...
  // Execute using proper VM context isolation paradigms with strict code generation rules
