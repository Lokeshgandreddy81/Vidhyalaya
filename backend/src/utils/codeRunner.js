...
export function executeSanitizedUserCode(userCodeString) {
  ...
  // We MUST use Object.create(null) recursively to sever the prototype chain
  // otherwise Sandbox Escape is possible via constructor.constructor("return process")()
