...
import { runInNewContext, createContext, runInContext } from 'vm';
...
export function executeSanitizedUserCode(userCodeString) {
  // Create an isolated context block mask using Object.create(null) to prevent prototype traversal
  ...
  // Use createContext with codeGeneration restrictions
