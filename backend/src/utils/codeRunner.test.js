...
describe('Cortex Code Sandbox Runner', () => {
  ...
  it('should block read access to backend/.env file (sandbox constraint)', { skip: !hasSandboxTool }, async () => {
...
`;
  ...
  it('should block network access (sandbox constraint)', { skip: !hasSandboxTool }, async () => {
    const code = `
