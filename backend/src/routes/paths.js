...
router.put('/:id', async (req, res) => {
  try {
    ...
    // Security Fix: Prevent mass assignment and NoSQL injection
    // Whitelist only the permitted update fields
    const {
      title, goal, expectedOutcome, targetDate, dailyCommitmentMinutes,
      preferredStartTime, phases, sessions, status, progress
    } = req.body;
