          ...
          <div className="space-y-6">
            <div className="space-y-2 text-center sm:text-left">
              ...
              <p className="text-[12px] font-medium text-slate-400 leading-relaxed">
                Cortex operates completely locally in your browser. To power the adaptive SARA learning engine, you need to provide a Gemini API Key from Google AI Studio.
              </p>
            </div>
