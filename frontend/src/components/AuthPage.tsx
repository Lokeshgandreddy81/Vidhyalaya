    ...
    <div className="min-h-screen w-full bg-gradient-to-tr from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0] text-slate-800 flex items-center justify-center relative overflow-hidden font-sans p-4">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          <div className="w-14 h-14 bg-gradient-to-tr from-indigo-600 via-[#000666] to-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-indigo-950/10 border border-white/20 relative overflow-hidden group">
