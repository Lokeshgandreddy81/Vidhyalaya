                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-white/5 mt-auto">
                        ...
                        <span className="text-[8px] font-black uppercase tracking-widest text-indigo-400/80 group-hover:text-indigo-400 animate-pulse">Tap to Open ✦</span>
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 select-text">
                          <h6 className={`text-[11px] font-black mb-1 leading-snug ${isZenMode ? 'text-indigo-300' : 'text-indigo-600'}`}>{item.title}</h6>
                          <p className={`text-[10px] font-medium leading-relaxed ${isZenMode ? 'text-slate-350' : 'text-slate-600'}`}>{item.content}</p>
                        </div>
                      </div>

                      {/* Footer back controls */}
                      <div className="flex items-center justify-between pt-2 border-t border-indigo-500/10 mt-2 shrink-0">
